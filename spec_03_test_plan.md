...
- [ ] No console errors during a 10-minute session.
- [ ] Network disconnected from internet: lab still runs (everything is local).
...
stages:
  ...
  - integration (only on main branch; spins up triton in docker)
